...
namespace WFPtest.Models
{
    ...
    public partial class requests1
    {
        public requests1()
        {
        ...
        public Nullable<int> RequstingBy { get; set; }
        public Nullable<System.DateTime> RequestingDate { get; set; }
        public Nullable<int> RequestingUnit { get; set; }
        ...
        public string DescripDaysORHours { get; set; }
        ...
        public Nullable<bool> NameTags { get; set; }
        public Nullable<bool> Writingpads { get; set; }
        public string ServicesReqOthers { get; set; }
